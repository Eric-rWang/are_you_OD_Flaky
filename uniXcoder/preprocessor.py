...
max_length = 512
lengths = [len(tokenizer.encode(text)) for text in texts_resampled]
...
train_texts, val_texts, train_labels, val_labels = train_test_split(
    texts_resampled, labels_resampled, test_size=0.2, random_state=42
)
...
if os.path.exists(model_dir):
    print("Re-fine-tuning the existing model...")
else:
